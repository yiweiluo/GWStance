...
You can use the pre-filtered data we provide (`output/dedup_combined_df_2000_1_1_to_2020_4_12.pkl`) or run `2_filter_dataset.py` on your own input dataset.
...
python 2_filter_dataset.py \
	--input_df_filename dedup_combined_df_2000_1_1_to_2020_4_12.pkl \	# where to read in dataset
